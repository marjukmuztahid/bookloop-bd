...
const CLASSES = ['All', 'Class 1', 'Class 2', 'Class 3', 'Class 4', 'Class 5', 'Class 6', 'Class 7', 'Class 8', 'SSC', 'HSC', 'O-Level', 'A-Level', 'Bachelors', 'Masters', 'IELTS', 'TOEFL', 'GRE', 'SAT'];
    ...
    jsonLd: [
      {
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://bookloopbd.com/?q={search_term_string}',
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <button
              ...
              className="inline-flex items-center justify-center rounded-xl border border-[rgba(232,53,122,0.30)] bg-[rgba(232,53,122,0.12)] px-8 py-3 text-[15px] font-semibold text-[#E8357A] backdrop-blur-[12px] transition-colors hover:bg-[rgba(232,53,122,0.20)] active:scale-95"
            >
              Browse Books
            </button>
            <button
